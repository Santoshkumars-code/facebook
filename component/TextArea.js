...
const TextArea = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
        ...
        />
        <TouchableOpacity style={styles.createpost} onPress={() => navigation.navigate('CreatePost')}>
        <Text >यहाँ कुछ लिखो... </Text>
        </TouchableOpacity>
      
      <TouchableOpacity>
      <Image  
         source={{uri:"https://img.icons8.com/external-anggara-flat-anggara-putra/32/000000/external-image-user-interface-anggara-flat-anggara-putra-3.png"}}
