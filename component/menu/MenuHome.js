...
const MenuHome = () => {
  return (
    <View >
    <View style={styles.MenuHome_container}>
        <MenuHeader />
    </View>
   <View style={styles.MenuHome_containercard}>
      ...
      <Image  
        ...
        <Text style={{width:200,height:20,fontSize:16,color:"black",fontWeight:"700",}}>Santosh Kumar</Text>   
        <Text style={{width:100,height:20,fontSize:14,color:"gray"}}>See your profile</Text>   
        </View>
       
      </TouchableOpacity>
   </View>

   <View style={{ marginRight:10,marginLeft:10,height:"420",marginTop:10}}>
    <Text>All shortcuts</Text>
    <View style={{flex:1,flexDirection:"row"}}>
      <View style={styles.MenuHome_card}></View>
      <View style={styles.MenuHome_card}></View>  
    </View>
    <View style={{flex:1,flexDirection:"row"}}>
      <View style={styles.MenuHome_card}></View>
